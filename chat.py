...
def generate_summary(docs):
    ...
    prompt = (
        "As an expert analyst, provide a comprehensive summary of the following document content. "
        "Include:\n"
        ...
        "Aim for a thorough yet concise summary that captures the essence of the document.\n\n"
        "CONTENT:\n" + text
    )
